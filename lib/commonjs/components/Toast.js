...
var _useAutoHide = require("../hooks/useAutoHide");
...
const Toast = () => {
  ...
  (0, _useAutoHide.useAutoHide)();
  const _onPress = (0, _react.useCallback)(() => {
    if (onPress) onPress();
    if (dismissible) hide();
  }, [onPress, dismissible, hide]);
  return (0, _react.useMemo)(() => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Swipeable.Swipeable, {
    onSwipe: hide,
    disabled: loading || !dismissible,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
      style: styles.container,
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNativeGestureHandler.Pressable, {
        disabled: loading || !dismissible,
        style: [styles.touchable, {
          backgroundColor: ToastColors[type]
        }],
        onPress: _onPress,
        children: [type !== "default" && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Image, {
          source: {
            uri: ToastIcons[type]
          },
          resizeMode: "contain",
